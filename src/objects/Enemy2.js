...
export default class Enemy extends Phaser.GameObjects.Image {
	...
	receiveSlow(level) {
		this.enemySpeed = (levelConfig.initial.enemySpeed * levelConfig.incremental.enemySpeed * level) /1.25;
	}

	receiveDamage(damage) {
		this.hp -= damage/4;
		if (this.enemySpeed > 1/80000) {
			this.enemySpeed /= 1.5;
		}
		else {
			this.enemySpeed = 1/80000;
		}
