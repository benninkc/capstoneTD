...
export default class GameScene extends Phaser.Scene {
	...
	createTowerButtons() {
		...
		this.tower1Button.x = 40;
		this.tower1Button.y = 420;

		this.tower2Button.x = 125;
		this.tower2Button.y = 420;

		this.tower3Button.x = 210;
		this.tower3Button.y = 420;
	...
	// startNewMap() {
	// 	this.level = 0;
	// 	// TODO: get the new map loaded properly.
	// 	// this.map = map.map2(function (arr) {
	// 	// 		return arr.slice();
	// 	// });

	// 	// TODO: create new functions for reset turrets instead of update
	...
	canPlaceTurret(i, j) {
		if (this.turretType === 1) {
			return this.map[i][j] === 0 && this.score >= 40;
		}
